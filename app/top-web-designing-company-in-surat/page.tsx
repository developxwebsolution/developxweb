...
const tocItems = [
  {
    id: "about-us",
    label: " Trusted Website Designing in Surat",
  },
  {
    id: "our-services",
    label:
  ...
  },
  {
    ...
    label: "Website Development & Digital Solutions in Surat",
  },
  {
    id: "why-choose-us",
    label:
      "Professional Web Development in Surat | Diamond City Website Experts",
  },
  {
    id: "our-achievements",
    label: "Why Businesses Trust Our Web Development Services in Surat",
  },
  { id: "Case-studies", label: "Work That Speaks" },
  {
    id: "our-process",
    label: "E-commerce & Business Growth with Surat's Trusted Web Agency",
  },
  {
    id: "our-technology",
    label: "Modern Web Technologies in Surat | Diamond City Web Development",
  },
  { id: "cta", label: "Ready for Expert Web Design in Surat?" },
  { id: "serving-industries", label: "Serving Industries" },
  {
    id: "local-benifits-section",
    label: "Benefits of a Local Web Design Company in Surat",
  },
  { id: "client-says", label: "See What Our Clients Say" },
  { id: "news-blogs", label: "News & Blogs Insights" },
  {
    id: "faqs-section",
    label: "FAQs – Your Dynamic Web Development Experts in Surat",
  },
  { id: "our-pricing", label: "Cost-Effective Website Development in Surat" },
...
const Page = () => {
  ...
  const location = "surat"; // dynamically choose location
  return (
    <>
      <div>
            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              ...
              <div className="mt-[10px] ">
                <p className="leading-[140%] text-white text-center md:text-left">
                  Expert Website Designing Company in Surat.
                </p>
              </div>
            </div>
            <HeaderForm />
            ...
            <div className="content-about flex items-center">
              <div>
                <h2 className="mb-[16px] heading-2 leading-[35px]">
                  Trusted Website Designing in Surat
                </h2>

                <p className="mb-[16px]">
                  Nowadays, websites serve as the online representation of a
                  business for users worldwide. People these dауѕ ѕеаrсh
                  іnfоrmаtіоn mostly оn ѕmаrtрhоnеѕ. Wеbѕіtеѕ should bе mobile
                  frіеndlу. If lооk аnd fееl іѕ not gооd, thеn most of the
                  people closest and ореn оthеr wеbѕіtеѕ.
                </p>

                <p className="mb-[16px]">
                  That situation is bаd аnd increases bоunсе rаtе which іѕ nоt
                  good fоr wеbѕіtе ranking. In оrdеr to bring a wеbѕіtе оnlіnе,
                  UI dеѕіgnеrѕ and dеvеlорmеnt tеаm should wоrk tоgеthеr. Thе
                  rеѕult іѕ еxресtеd with{" "}
                  <strong>best wеbsite dеѕіgnіng company</strong> wіth еxреrtѕ
                  working tо provide premium quality work. There аrе many
                  соmраnіеѕ wіth Lаѕеr Web Mаkеr оffеrіng services in wеb
                  dеѕіgnіng аnd ѕоmе оf thе best соmраnіеѕ аrе аѕ fоllоwѕ.
                </p>
                <p>
                  ...
                  , offering professional services in web designing, and some of
                  the top-rated{" "}
                  <strong>
                    <Link href={"/top-web-designing-company-in-surat"}>
                      website designing company in Surat
                    </Link>
                  </strong>{" "}
                  and best website designing company in Surat deliver
                  exceptional digital solutions tailored to client needs.
                </p>
              </div>
            </div>
            <div className="img relative h-full">
              <Image
                src="/images/LandingPageImg/Top-Web-Designing-Company-In-Surat.jpg"
                alt="Web development team working on modern website design and development at Laser Web Maker"
                width={400}
                height={400}
                title="Top-Web-Designing-Company-Surat"

            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              ...
              <div className="mt-[10px] ">
                <p className="leading-[140%] text-white text-center md:text-left">
                  Get a Shopify expert to grow your online store.
                </p>
              </div>
            </div>
            <HeaderForm />
        ...
        <div className="section-style grid grid-cols-1 md:grid-cols-2 gap-[20px]">
          <div className="content-about flex items-center">
            <div>
               ...
               <p className="mb-[16px]">
                If you’ve been searching for a <strong>trusted Shopify developer</strong> who
                actually understands how to build or grow an online store,
                you’re in the right place. A lot of businesses come to us
                because they want something simple: a Shopify store that looks
                clean, works smoothly, and helps them sell more without constant
                headaches.
              </p>
              <p>
                We offer Shopify development services that focus on real goals—
                better speed, better shopping experience, and a setup that feels
                right for your brand. Whether you’re launching a fresh new
                store, fixing an outdated one, or planning to add custom
                features, our dedicated team handles it with the kind of care
                you’d expect from <strong>top Shopify experts</strong>.
              </p>
              <p>
                The goal is pretty straightforward: turn your ideas into a store
                that’s professional, easy to manage, and affordable to maintain.
                And yes, we make sure everything is delivered on time without
          ...
          <div className="img relative h-full">
                    <Image
                      src="/images/hire-shopify-developer/hire-shopify-developer-about-us.webp"

...
const tocItems = [
  {
    id: "about-us",
    label: "Trusted WordPress E-Commerce Web Development in Noida",
  },
  {
    id: "our-services",
    label: "Expert WordPress E-commerce Development | WooCommerce Solutions",
  },
  {
    id: "our-website-services",
    label:
      "We Create High-Converting WordPress Stores | E-commerce Development Experts",
  },
  {
    id: "why-choose-us",
    label: "WordPress E-commerce Development | WooCommerce Specialists",
  },
  {
    id: "our-achievements",
    label:
      "Sell More with WooCommerce: WordPress E-Commerce Development Experts",
  },
  { id: "Case-studies", label: "Work That Speaks" },
  {
    id: "our-process",
    label:
      "Create a Powerful Online Store with WooCommerce & WordPress Development",
  },
  {
    id: "our-technology",
    label:
      "WordPress Ecommerce Website Development Company | WooCommerce Specialists",
  },
  { id: "cta", label: "Need WordPress E-commerce Website Development?" },
  { id: "serving-industries", label: "Serving Industries" },
  {
    id: "local-benifits-section",
    label: "WordPress Ecommerce Website Development Company",
  },
  { id: "client-says", label: "See What Our Clients Say" },
  { id: "news-blogs", label: "News & Blogs Insights" },
  {
    id: "faqs-section",
    label: "FAQs – Building High-Converting WooCommerce Stores with WordPress",
  },
  {
    id: "our-pricing",
    label:
      "WordPress Ecommerce Website Development Company | WooCommerce Experts",
  },
...
const Page = () => {
  ...
  const location = "wordpressEcommerce"; // dynamically choose location
  return (
    <>
      <div>
            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              <div className="flex flex-col">
                <h1 className="main-heading text-white text-center md:text-left">
                  Top WordPress E-commerce Web Development Company in Noida
                </h1>
              </div>
      ...
      <section id="about-us">
            ...
            <div className="content-about flex items-center">
              <div>
                <h2 className="mb-[16px] heading-2 leading-[35px]">
                  Trusted WordPress E-Commerce Web Development in Noida
                </h2>

                <p className="mb-[16px]">
                  Woo Commerce is a wordpress plugin that contains E-commerce
                  features.{" "}
                  <strong>
                    <Link
                      target="_blank"
                  ...
                  developed and integrate theme in woo commerce plugin.
                </p>
                <p>
                  Woocommerce is a wordpress plugin which contains e-commerce
                  features . It a very famous plugin if you have any doubt or
                  issue then you can easy find solution by search in google .
                  <Link
                    target="_blank"
                    href={"https://maps.app.goo.gl/3sEB9CCbRb3eskgKA"}
                  >
                  ...
                  is offering woo theme integration in very reasionable cost .
                  Woocommerce is an open source plugin that you can easily sell
                  you product without any inturption.
                </p>
              </div>
            </div>
            <div className="img relative h-full">
              <Image
                src="/images/LandingPageImg/Wordpress-Ecommerce-Website-Development-Company.jpg"
                alt="Web development team working on modern website design and development at Laser Web Maker"
                width={450}
                height={450}
                title="Wordpress-Ecommerce-Website-Development-Company"
        ...
        <div className="section-style2 bg-[#f9f9f9]">
          ...
          >
            Some Features of woocommerce are:-
          </motion.h2>

          <ol className="list-decimal pl-6 mb-6 space-y-4">
            <li>
              Sell your products anytime and from anywhere, giving you complete
              freedom to manage and grow your online business without
              limitations.
            </li>
            <li>
              Easily integrate multiple payment gateways so customers can make
              secure and convenient payments using their preferred methods.
            </li>
            <li>
              A user-friendly admin panel that makes it simple to manage
              products, orders, customers, and reports without technical
              complexity.
            </li>
            <li>
              Enjoy full control over your store, including design, pricing,
              inventory, and functionality, tailored to your business needs.
            </li>
            <li>
              Built with strong security features to protect your store data and
              ensure safe transactions for both you and your customers.
            </li>
          </ol>
        </div>
      </section>

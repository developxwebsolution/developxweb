            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              ...
              <div className="mt-[10px] ">
                <p className="leading-[140%] text-white text-center md:text-left">
                  Tailored PHP development for powerful, scalable solutions.
                </p>
              </div>
            </div>
            <HeaderForm />
      ...
      <section id="about-us">
        <div className="section-style grid grid-cols-1 md:grid-cols-2 gap-[20px]">
          <div className="content-about flex items-center">
            <div>
              <p className="mb-[16px]">
                If you want to build a PHP website that is both budget-friendly
                and high-performing, Laser Web Maker is the perfect choice. We
                specialize in creating creative, powerful, and functional
                PHP-based websites that load fast, look modern, and offer
                seamless user experiences.
                <strong>
                  {" "}
                  PHP is one of the most dependable and flexible web
                  technologies.{" "}
                </strong>
              </p>
              <p>
                It easily integrates with HTML, making it ideal for building
                dynamic, database-driven, and high-speed websites. With each new
                version, PHP continues to evolve—bringing better performance,
                stronger security, and improved features. At Laser Web Maker, we
                use the latest PHP standards, frameworks, and coding practices
          ...
          <div className="img relative h-full">
            <Image
              src="/images/about-us/php-web-development-about-us.webp"
              alt="Web development team working on modern website design and development at Laser Web Maker"
              width={450}
              height={450}
              title="Laser Web Maker - Professional PHP Web Development Services"

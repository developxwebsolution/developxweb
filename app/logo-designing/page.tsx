...
const Page = () => {
  ...
  return (
    <>
            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              ...
              <div className="mt-[10px] ">
                <p className="leading-[140%] text-white text-center md:text-left">
                  Memorable logos that define your brand.
                </p>
              </div>
            </div>
            <HeaderForm />
        ...
        <div className="section-style grid grid-cols-1 md:grid-cols-2 gap-[20px]">
          <div className="content-about flex items-center">
            <div>
              ...
              <p className="mb-[16px]">
                A lot of people underestimate the power of a well-designed logo.
                But in reality, a good logo is the face of your business — the
                silent brand ambassador that works 365 days a year without
                taking a break. Look at the logos of multinational companies;
                they weren’t created by chance. They were crafted thoughtfully
                to communicate trust, professionalism, and personality.
              </p>

              <p>
                At Laser Web Maker, we understand how impactful a strong logo
                can be. A properly designed graphic logo speaks louder than
                words and transcends language barriers. Even someone who doesn’t
                know English can instantly recognize a powerful visual identity.
                That’s the magic of a globally recognizable logo.
              </p>
              <p>
                Today, countless emerging brands aspire to build their image
                with a meaningful and memorable identity. If you’re searching
                for a reliable and top-rated logo design company that offers
                premium creativity at affordable rates — your search ends here.
              </p>
            </div>
          </div>
          ...
          <div className="img relative h-full">
            <Image
              src="/images/about-us/logo-designing-about-us.webp"
              alt="Web development team working on modern website design and development at Laser Web Maker"
              width={650}
              height={650}
              title="Laser Web Maker - Professional Logo Designing Services"
      ...
      {/* truested  */}
      <TrustSection content={trustContent.default} />;{/* truested end */}
      {/* clientstudies start */}
      <PortfolioSlider />
      {/* clientstudies end */}
      {/* our process  */}

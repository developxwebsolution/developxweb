            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              ...
              <div className="mt-[10px] ">
                <p className="leading-[140%] text-white text-center md:text-left">
                  Feature-rich Prestashop stores for growing brands.
                </p>
              </div>
            </div>
            <HeaderForm />
      ...
      <section id="about-us">
        <div className="section-style grid grid-cols-1 md:grid-cols-2 gap-[20px]">
          <div className="content-about flex items-center">
            <div>
              <p className="mb-[16px]">
                PrestaShop works really well for businesses that want an online
                store without spending a fortune. It’s flexible, easy to handle,
                and gives you a lot of freedom when you’re building your secure
                shop. That’s why so many people pick it when they’re starting
                out or upgrading their eCommerce setup — it just makes sense if
                you want a scalable eCommerce store without the extra hassle.
              </p>

              <p>
                At Laser Web Maker, we’ve been doing{" "}
                <strong><Link href={"/prestashop-website-development"}>top PrestaShop website development</Link></strong> for years,
                and people usually come to us because they want something
                reliable, not complicated. We’re known as a trusted PrestaShop
                development company, and most of the time our work is about
                making sure the store loads fast, feels good to use, and
                actually helps with sales. Nothing fancy for the sake of it -
                just a custom PrestaShop store that works the way you need it
                to.
              </p>
            </div>
          </div>
          <div className="img relative h-full">
            <Image
              src="/images/prestashop-web-development/prestashop-website-development-about-us.webp"
              alt="Web development team working on modern website design and development at Laser Web Maker"
              width={500}
              height={500}
              title="Laser Web Maker - Professional PrestaShop Web Development Services"

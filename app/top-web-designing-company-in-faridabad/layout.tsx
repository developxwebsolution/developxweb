...
export const metadata: Metadata = {
  title: "Top Web Designing Company in Faridabad | Laser Web Maker",
  description:
    "Laser Web Maker is a professional web designing company in Faridabad offering modern, SEO-optimized websites for businesses.",
  keywords: [
    "top web designing company in faridabad",
    "best website designers faridabad",
    "web design company near me",
      "top website designing company in faridabad",
    "best website desinging company in faridabad",
    "best website desinging company in faridabad",
  ...
  alternates: {
    canonical:
      "https://laserwebmaker.com/top-web-designing-company-in-faridabad",
  },
};
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <Script type="application/ld+json" id="localbusiness-faridabad">
        {JSON.stringify({
  ...
  {JSON.stringify({
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Which is the top web development company in Faridabad?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Laser Web Maker is a trusted and top-rated web development company in Faridabad, known for building fast, secure, and SEO-friendly websites for businesses.",
        },
      },
      {
        "@type": "Question",
        name: "Do you provide web development services near me in Faridabad?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes, Laser Web Maker provides professional web development services across Faridabad and nearby areas with full online support.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "How much does website development cost in Faridabad?",
        acceptedAnswer: {
          "@type": "Answer",

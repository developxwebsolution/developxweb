            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              ...
              <div className="mt-[10px] ">
                <p className="leading-[140%] text-white text-center md:text-left">
                 Bring your vision to life with a dedicated designer.
                </p>
              </div>
            </div>
            <HeaderForm />
        ...
        <div className="section-style grid grid-cols-1 md:grid-cols-2 gap-[20px]">
          <div className="content-about flex items-center">
            <div>
              ...
              <p className="mb-[16px]">
                These days, everything moves so quickly online that having a
                proper website isn’t just a fancy extra anymore — it’s basically
                your brand’s identity. Whether it’s a government office, a
                school, a media group, or a small business trying to get
                noticed, everyone needs a site that’s clean, easy to use, and
                actually represents them well. That’s why a lot of people search
                for <strong>professional website development</strong> or a{" "}
                <strong>trusted website design company</strong> instead of
                settling for something basic.
              </p>
              <p>
                And when you start planning your online presence, you obviously
                want someone who’s <strong>most trusted</strong>,{" "}
                <strong>affordable</strong>, and actually understands what
                you’re trying to do. A lot of businesses prefer working with a
                team that can handle custom website design, responsive web
                design, and overall business website development without blowing
                up the budget.
              </p>
              <p>
                That’s exactly where <strong>Laser Web Maker</strong> fits in.
                We focus on making websites that feel natural, load fast, and
                genuinely help your business look more professional. No
                complicated jargon — just simple, practical work that does what
                it’s supposed to do.
              </p>
            </div>
          </div>
          <div className="img relative h-full">
            <Image
              ...
              width={550}
              height={550}
              title="Laser Web Maker - Professional Hire Website Designer Services"

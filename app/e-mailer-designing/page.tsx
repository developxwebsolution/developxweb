            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              ...
              <div className="mt-[10px] ">
                <p className="leading-[140%] text-white text-center md:text-left">
                  Engaging email designs that get opened and clicked.
                </p>
              </div>
            </div>
            <HeaderForm />
      ...
      <section id="about-us">
        <div className="section-style grid grid-cols-1 md:grid-cols-2 gap-[20px]">
          <div className="content-about flex items-center">
            <div>
              <p className="mb-[16px]">
                We create impactful and{" "}
                <strong>professionally designed emailers</strong> that help your
                business connect with customers, promote offers, build trust,
                and increase conversions. Whether you want to announce a
                product, run a sale, send newsletters, or share updates—our
                emailer designs are built to get attention and drive action.
              </p>

              <p>
                Emailer designing focuses on creating visually engaging and
                high-performing <strong>email designs</strong> for marketing
                campaigns. We provide design-only services, delivering
                print-ready and digital-ready email formats that work seamlessly
                across all devices and email clients.
              </p>

              <p>
                A well-designed email is more effective than printed coupons or
                shared mail programs. Unlike newspapers, inserts, or shared
                coupon mailers—your digital emailer gets direct attention inside
                the recipient’s inbox. No distractions, no competition.
              </p>
            </div>
          </div>
          ...
          <div className="img relative h-full">
            <Image
              src="/images/about-us/emailer-designing-about-us.webp"
              alt="E-mailer Designing Services"
              width={550}
              height={550}
              title="Laser Web Maker - Professional E-mailer Designing Services"

            ...
            <div className="md:flex-[2] flex-col gap-4 justify-center items-center">
              ...
              <div className="mt-[10px] ">
                <p className="leading-[140%] text-white text-center md:text-left">
                  Power your online sales with custom WooCommerce.
                </p>
              </div>
            </div>
            <HeaderForm />
      ...
      <section id="about-us">
        <div className="section-style grid grid-cols-1 md:grid-cols-2 gap-[20px]">
          <div className="content-about flex items-center">
            <div>
              <p className="mb-[16px]">
                WooCommerce is a WordPress plugin that contains e-commerce
                features. It is a very famous plugin. At Laser Web Maker, we
                provide top-rated and{" "}
                <strong>
                  most trusted WooCommerce website development services
                </strong>{" "}
                for businesses that want a powerful, scalable, and
                easy-to-manage online store.
              </p>
              <p>
                If you have any doubts or issues, then you can easily find a
                solution by searching on Google.{" "}
                <strong><Link href={"https://laserwebmaker.com/"}>LaserWebMaker.com</Link></strong> is offering Woo theme
                integration at a very reasonable cost. WooCommerce is an
                open-source plugin that you can use to easily sell your products
          ...
          <div className="img relative h-full">
            <Image
              src="/images/woocommerce-web-development/woocommerce-website-development-about-us.webp"
              alt="Web development team working on modern website design and development at Laser Web Maker"
              width={500}
              height={500}
              title="Laser Web Maker - Professional WooCommerce Web Development Services"

...
export const metadata: Metadata = {
  title: "Top Web Designing Company in Abu Dhabi UAE | Laser Web Maker",
  description:
    "Laser Web Maker is a professional web designing company in Abu Dhabi UAE offering custom, SEO-optimized, and high-performing websites.",
  keywords: [
    "top web designing company in abu dhabi",
    "best website designers in uae",
    "web design company near me",
    "professional web designers abu dhabi",
  ],
  robots: "index, follow",
  alternates: {
    canonical:
      "https://laserwebmaker.com/top-web-designing-company-in-abudhabi-uae",
  },
};
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <Script type="application/ld+json" id="localbusiness-abudhabi">
        {JSON.stringify({
  ...
  {JSON.stringify({
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Which is the top web development company in Abu Dhabi?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Laser Web Maker is a trusted and top-rated web development company in Abu Dhabi, known for building fast, secure, and SEO-friendly websites for businesses.",
        },
      },
      {
        "@type": "Question",
        name: "Do you provide web development services near me in Abu Dhabi?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes, Laser Web Maker provides professional web development services across Abu Dhabi and nearby areas with full online support.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "How much does website development cost in Abu Dhabi?",
        acceptedAnswer: {
          "@type": "Answer",

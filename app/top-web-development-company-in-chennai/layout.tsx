...
export const metadata: Metadata = {
  title: "Top Web Development Company in Chennai | Laser Web Maker",
  description:
    "Laser Web Maker is a professional web development company in Chennai offering custom, responsive, and SEO-ready websites.",
  keywords: [
    "top web development company in chennai",
    "best web developers chennai",
    "website development company near me",
    "top website designing company in chennai",
    "best website desinging company in chennai",
  ...
  alternates: {
    canonical:
      "https://laserwebmaker.com/top-web-development-company-in-chennai",
  },
};
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <Script type="application/ld+json" id="localbusiness-chennai">
        {JSON.stringify({
  ...
  {JSON.stringify({
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Which is the top web development company in Chennai?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Laser Web Maker is a trusted and top-rated web development company in Chennai, known for building fast, secure, and SEO-friendly websites for businesses.",
        },
      },
      {
        "@type": "Question",
        name: "Do you provide web development services near me in Chennai?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes, Laser Web Maker provides professional web development services across Chennai and nearby areas with full online support.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "How much does website development cost in Chennai?",
        acceptedAnswer: {
          "@type": "Answer",

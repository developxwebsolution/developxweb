    ...
    >
      ...
      <div className="relative container mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        <motion.div
          ...
          viewport={{ once: false }}
        >
          <h2 className="our-trust-heading  text-3xl md:text-4xl font-bold mb-6 leading-snug" style={{color:"white" }}>
          ...
          <p className="max-w-xl mx-auto md:mx-0 mb-8 text-lg opacity-90">
            ...
            result-driven digital experience. Partner with us today and 
...
>
  ...
  >
    <Image
    fill
      src="/images/home_img/call-to-action-img1.webp"
      alt="Ready to Take Your Project to the Next Level"

...
const words = ["Development", "Designing"];
export default function Home() {
  ...
  return (
    <>
      <div className=" container-width mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-0">
        {/* First Image with Text */}
        <div className="relative w-full h-[400px] md:h-[700px] ">
          <Image
            src="/images/home_img/web-development-company-laserwebmaker.webp"
        ...
        <div className="relative w-full h-[400px] md:h-[700px] ">
          <Image
            src="/images/home_img/home-banner.jpg"
            alt="Web-Development-Company"
            fill
            className="object-cover"
             fetchPriority="high"
          ...
          <div className=" absolute top-1 md:top-auto md:bottom-0  left-0 md:left-[12] right-0 px-[15px] md:px-12 p-10">
            ...
            <div className="inline-flex items-center mb-0 flex-wrap">
              <span className="  text-white text-[35px] sm:text-4xl md:text-[40px] pt-2  leading-[50px]  font-bold">
                #Web
              </span>

              <span className="ml-2 rounded-full bg-white/10">
                <h2 className="home-banner-heading text-white text-[28px] md:text-[40px] pl-3  pt-1 pb-1 italic leading-[50px] font-medium">
                  {text}
                  <span className="animate-pulse">|</span>
                </h2>
              </span>
            </div>
            <h2 className=" home-banner-heading text-white text-[32px] md:text-[40px] mb-2 font-bold leading-[50px]  ">
              Company
            </h2>
            {/* hover:scale-105 transition */}
            <div className="px-5 md:px-5 py-[10px] group text-[16px] md:text-[18px] inline-flex items-center justify-center gap-[10px] mt-3 md:mt-5 rounded-[30px] bg-gradient-to-t from-white via-white to-white text-[#057BC1]  w-max">
             <Link href="/contact" className="inline-flex items-center justify-center gap-2">
              <span className=" text-[16px]  rounded-[20px]  md:text-[18px] font-semibold leading-[26px]">
                Contact Us
              </span>
              <Image
      ...
      {/* section second location section correct */}

...
const tabs: Tab[] = [
  {
    ...
    alt: "Local Insight - Noida Web Design",
  },
  {
    id: "collaboration",
    title: "Face-to-Face",
    ...
    alt: "Face-to-Face Collaboration",
  },
  {
    id: "turnaround",
    ...
    alt: "Faster Turnaround - Local Web Design",
  },
  {
    id: "support",
    title: "Local Support",
  ...
  },
  {
    ...
    alt: "Personalized Service by Local Web Design",
  },
  {
    id: "economy",
    ...
    alt: "Supporting Local Economy - Noida",
  },
];
            ...
            {activeTab && (
              ...
              >
                ...
                <motion.img
                  key={activeTab.image}
                  src={activeTab.image}
                  alt={activeTab.alt || activeTab.title} // dynamically added alt
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.6 }}
                ...
                <div className="p-6">
                  ...
                  <p className="text-black leading-relaxed">{activeTab.content}</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
